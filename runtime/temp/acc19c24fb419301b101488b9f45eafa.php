<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"F:\sendm\app\P2PApp\public/../application/index\view\user\login.html";i:1512198163;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" type="text/css" href="http://www.tp5.com/static/css/common.css" />
    <script type="text/javascript" src="http://www.tp5.com/static/script/jquery.js"></script>
</head>
<body>
<!-- 页面头部 -->
<section>
...
<div class="register">
    <div class="wrapper-reg">
        <div class="page-header"> <a href="/"> <img src="http://www.tp5.com/static/images/reg-logo.png"> </a> </div>
        <div class="page-main">
            <form action="" method="post" id="user-login-form" accept-charset="UTF-8" class="reg-form">
                ...
                <div class="m-field m-yzm" id="imageCode" >
                    <div class="m-code">
                        ...
                        <div><img src="http://www.tp5.com/yzm.php" alt="captcha" alt="no pic"/></div>
                    </div>
                    <span class="c-yzm"><img style="height: 100%;" src="http://www.tp5.com/yzm.php"></span>
            ...
            <div class="m-ljzc"> 没有账号？<a href="#">立即注册</a> </div>
        </div>
    </div>
</div>
<script>
    ...
    //验证码
    $('.c-yzm').click(function(){
        var src = $(this).children('img').attr('src');
        $(this).children('img').attr('src','http://www.tp5.com/yzm.php?code = '+Math.random());
    })
...
<script type="text/javascript" src="http://www.tp5.com/static/script/jsf.js.htm"></script>
